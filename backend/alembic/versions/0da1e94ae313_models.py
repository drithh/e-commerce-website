...
Revision ID: 0da1e94ae313
Revises: 
Create Date: 2022-10-21 08:35:57.904084
...
def upgrade():
    ...
    op.execute("DROP TABLE IF EXISTS product_size_quantities CASCADE;")
    ...
    op.execute("DROP TABLE IF EXISTS forgot_passwords CASCADE;")
    op.execute("DROP TABLE IF EXISTS banners CASCADE;")
