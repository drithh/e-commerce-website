...
Revision ID: 7abb74d40ddc
Revises: 
Create Date: 2022-12-07 14:52:40.274238
...
def upgrade():
    ...
    sa.Column('image_id', fastapi_users_db_sqlalchemy.generics.GUID(), nullable=True),
    ...
    sa.Column('expires_in', sa.DateTime(timezone=True), server_default=sa.text("now() + interval '15 minutes'"), nullable=False),
