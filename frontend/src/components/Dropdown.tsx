...
const Dropdown = ({ params, setParams }: props) => {
  ...
  return (
    <Menu as="div" className="relative inline-block w-full text-left">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 w-[15.5rem] origin-top divide-y rounded bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          {sorts.map((sort) => (
